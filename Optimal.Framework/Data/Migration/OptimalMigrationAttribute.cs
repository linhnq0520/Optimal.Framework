    ...
    public class OptimalMigrationAttribute : MigrationAttribute
    {
        ...
        private static long GetVersion(string dateTime)
        {
            return DateTime
                .ParseExact(
                    dateTime,
                    OptimalMigrationDefaults.DateFormats,
        ...
        )
        {
            return string.Format(
                OptimalMigrationDefaults.UpdateMigrationDescription,
                neptuneVersion,
                migrationType.ToString()
            );
        }

        public OptimalMigrationAttribute(
            string dateTime,
        ...
        public OptimalMigrationAttribute(
            ...
            : base(
                GetVersion(dateTime, migrationType),
                GetDescription(neptuneVersion, migrationType)
            )
        {
            TargetMigrationProcess = targetMigrationProcess;
        }
